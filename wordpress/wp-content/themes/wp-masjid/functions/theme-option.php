...
function masjid_add_page() {
    $masjid_options_page = add_menu_page( 'Pengaturan Tema', '<strong style="color: #8dbf9e;">WP Masjid v1.3</strong>', 'manage_options', 'wp-masjid', 'options_page', 'dashicons-list-view', 2 );
} 
...
function options_page() {
	...
	if ($_POST['update_options'] == 'true') {
		...
		update_option('embedmaps', stripslashes($_POST['embedmaps'])); 
		...
		update_option('IDkota', $_POST['IDkota']);
		...
		update_option('bank1', stripslashes($_POST['bank1'])); 
		update_option('bank2', stripslashes($_POST['bank2'])); 
		update_option('bank3', stripslashes($_POST['bank3'])); 
		update_option('bank4', stripslashes($_POST['bank4']));

		update_option('kode1', stripslashes($_POST['kode1'])); 
		update_option('kode2', stripslashes($_POST['kode2'])); 
		update_option('kode3', stripslashes($_POST['kode3'])); 
		update_option('kode4', stripslashes($_POST['kode4']));
		
		update_option('rek1', stripslashes($_POST['rek1'])); 
		update_option('rek2', stripslashes($_POST['rek2'])); 
		update_option('rek3', stripslashes($_POST['rek3'])); 
		update_option('rek4', stripslashes($_POST['rek4']));
		
		update_option('atas1', stripslashes($_POST['atas1'])); 
		update_option('atas2', stripslashes($_POST['atas2'])); 
		update_option('atas3', stripslashes($_POST['atas3'])); 
		update_option('atas4', stripslashes($_POST['atas4']));
		
		update_option('logos', $_POST['logos']);
		update_option('favicon', $_POST['favicon']);
		update_option('share', $_POST['share']);
					    	...
					    	<div id="welcome">
						    	<div class="wel">
									...
									<?php if ( $user ) : ?>
										...
										facebook : <a href="http://facebook.com/ciussgw">yayun</a> | <i class="fa fa-envelope"></i> yayun@ciuss.com<br/>
									</div>
								</div>
							</div>
