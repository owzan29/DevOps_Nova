					...
					<td>
						<div class="comment-text">
							<?php if ($comment->comment_approved == '0'): ?>
								<p><?php _e('Komentar Anda menunggu disetujui admin.', 'idealer') ?></p>
								<br/>
							<?php endif; ?>
							<?php printf(__('<p class="comment-author"><span>%s</span>, <em>%s</em></p>'), get_comment_author_link(), get_comment_date('l, j M Y')) ?>
							<?php comment_text() ?>
